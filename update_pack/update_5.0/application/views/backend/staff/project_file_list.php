                ...
                <td>
                    <?php if ($row1['description'] != ''):?>
                                    ...
                                    <a class="tooltip-default" style="color:#aaa;" data-toggle="tooltip" 
                                       ...
                                       href="<?php echo site_url('staff/project_file/download/' . $row1['project_file_id']); ?>">
                                    ...
                                    <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="confirm_modal('<?php echo site_url('staff/project_file/delete/' . $row1['project_file_id']); ?>', '<?php echo site_url('staff/reload_projectroom_file_list/' . $project_code); ?>');">
