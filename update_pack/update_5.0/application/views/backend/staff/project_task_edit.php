    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('staff/project_task/edit/'.$param3), array('class' => 'form-horizontal form-groups-bordered validate project-task-edit', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <select name="staff_id" class="select2">
                          ...
                          <?php
                          $assigned_staffs = $this->db->get_where('project', array('project_id' => $row['project_id']))->row()->staffs;
                          $array = explode(',', $assigned_staffs);
                          $number_of_assigned_staffs = count($array) - 1;
                          for ($i = 0; $i < $number_of_assigned_staffs; $i++):?>
                            <option value="<?php echo $array[$i];?>"
                                <?php if ($row['staff_id'] == $array[$i]) echo 'selected'; ?>>
                              <?php echo $this->db->get_where('staff', array('staff_id' => $array[$i]))->row()->name; ?>
                            </option>
                          <?php endfor; ?>
                      </select>
                    </div>
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('staff/reload_projectroom_task/' . $param2); ?>';
</script>
