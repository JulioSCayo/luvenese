    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('staff/team_task_file/upload/' . $param2), array('class' => 'form-horizontal form-groups-bordered validate team-task-file-add', 'enctype' => 'multipart/form-data')); ?>
...
<script>
    ...
    function show_response_team_task_file_add(responseText, statusText, xhr, $form) {
        ...
        reload_team_task_information_archived('<?php echo site_url('staff/reload_team_task_information_archived/' . $param2); ?>');
