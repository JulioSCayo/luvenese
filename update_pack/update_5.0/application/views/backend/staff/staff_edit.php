	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('staff/staff/edit/'.$row['staff_id']), array('class' => 'form-horizontal form-groups-bordered ajax-submit', 'enctype' => 'multipart/form-data'));?>
...
<script>
	...
	var post_refresh_url	=	'<?php echo site_url('staff/reload_staff_list');?>';
