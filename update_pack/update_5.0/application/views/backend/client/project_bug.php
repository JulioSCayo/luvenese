                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="showAjaxModal('<?php echo site_url('modal/popup/project_bug_edit/' . $row1['project_bug_id']); ?>');">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="confirm_modal('<?php echo site_url('client/project_bug/delete/' . $row1['project_bug_id']); ?>', '<?php echo site_url('client/reload_projectroom_bug/' . $project_code); ?>');">
