...
<!--required for getting the stripe token-->
        ...
        <img src="<?php echo base_url('uploads/logo.png');?>" width="25%;"
            style="opacity: 0.05;">
            <form method="post"
              action="<?php echo site_url('client/pay/stripe/' . $project_milestone_details['project_milestone_id']);?>">
              <label>
                  <div id="card-element" class="field is-empty"></div>
                  <span><span><?php echo get_phrase('credit_/_debit_card');?></span></span>
              </label>
              <button type="submit">
                  <?php echo get_phrase('pay');?> $<?php echo $project_milestone_details['amount'];?>
              </button>
              <div class="outcome">
              ...
              <div class="package-details">
                  ...
                  <?php echo get_phrase('package');?> | <?php echo $project_milestone_details['title'];?> <br>
              </div>
