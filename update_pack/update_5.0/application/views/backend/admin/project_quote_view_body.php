            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="padding:0px;">
                                    ...
                                    <article class="story" style="padding:0px 10px 0px 20px; margin:20px 0px;">
                                        ...
                                        <div class="story-content">
                                            ...
                                            <?php if ($row2['file'] != "") { ?>
                                                ...
                                                <a href="<?php echo site_url('uploads/quote_file/' . $row2['file']);?>" class="">
                                                    <?php echo $row2['file']; ?>
                                                </a>
                                            <?php } ?>
                    ...
                    <!-- reply option only for opened ticket-->
                        ...
                        <?php
                        echo form_open(site_url('admin/project_quote_post_reply/' . $row['quote_id']), array('class' => 'form-horizontal form-groups validate ticket-message-add',
...
<script>
    ...
    {
        $.ajax({
            url: '<?php echo site_url('admin/reload_quote_message_view_body/' . $row['quote_id']); ?>',
