    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/accounting_expense_category/edit/' . $param2), array(
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('admin/reload_expense_category_list'); ?>';
</script>
