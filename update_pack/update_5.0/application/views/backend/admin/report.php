...
// $currency_symbol    =   $this->db->get_where('currency' , array('currency_id' => $currency_id))->row()->currency_symbol;
 echo form_open(site_url('admin/report/' . $report_type), array('class' => 'form-horizontal form-groups validate',  'id' => 'date_selector_form'));?>

<?php if ($report_type != 'monthly_project'): ?>
