		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title">
					...
					<a href="<?php echo site_url('admin/staff');?>" class="pull-right tooltip-primary" 
				...
				<table class="table    table-hover table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>
				            	<a href="#" class="btn btn-primary btn-xs" onclick="showAjaxModal('<?php echo site_url('modal/popup/staff_profile/' . $row['staff_id']); ?>');">
                                	<i class="entypo-user"></i>
                            	</a>
				           </td>
						</tr>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title">
					...
					<a href="<?php echo site_url('admin/client');?>" class="pull-right tooltip-primary" 
				...
				<table class="table    table-hover table-striped">
					...
					<tbody>
						...
						<tr>
							<td><?php echo $row['name'];?></td>
							<td>
				            	<a href="#" class="btn btn-primary btn-xs" onclick="showAjaxModal('<?php echo site_url('modal/popup/client_profile/' . $row['client_id']); ?>');">
                                	<i class="entypo-user"></i>
                            	</a>
				           </td>
						</tr>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title">
					...
					<a href="<?php echo site_url('admin/project');?>" class="pull-right tooltip-primary" 
				...
				<table class="table    table-hover table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>
				            	<a href="<?php echo site_url('admin/projectroom/wall/' . $row['project_code']);?>" 
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title">
					...
					<a href="<?php echo site_url('admin/team_task');?>" class="pull-right tooltip-primary" 
				...
				<table class="table    table-hover table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>
				            	<a href="<?php echo site_url('admin/team_task_view/' . $row['team_task_id']);?>" 
				            		class="btn btn-primary btn-xs">
                                	<i class="entypo-target"></i>
                            	</a>
				           </td>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title">
					...
					<a href="<?php echo site_url('admin/support_ticket');?>" class="pull-right tooltip-primary" 
