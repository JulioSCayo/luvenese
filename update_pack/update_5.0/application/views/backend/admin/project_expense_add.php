    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/project_expense/create/'.$param2), array('class' => 'form-horizontal form-groups-bordered project-expense-add', 'enctype' => 'multipart/form-data')); ?>
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('admin/reload_projectroom_expense/' . $param2); ?>';
</script>
