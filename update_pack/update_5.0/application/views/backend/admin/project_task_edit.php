    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/project_task/edit/'.$param3), array('class' => 'form-horizontal form-groups-bordered validate project-task-edit', 'enctype' => 'multipart/form-data')); ?>
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('admin/reload_projectroom_task/' . $param2); ?>';
</script>
