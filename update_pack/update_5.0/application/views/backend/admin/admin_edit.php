	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/admins/edit/' . $row['admin_id']), array('class' => 'form-horizontal form-groups-bordered ajax-submit', 'enctype' => 'multipart/form-data'));?>
...
<script>
	...
	var post_refresh_url	=	'<?php echo site_url('admin/reload_admin_list');?>';
