    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/project_expense/edit/' . $param2), array(

                    'class' => 'form-horizontal form-groups-bordered project-expense-edit', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row['title']; ?>" name="title" value="" autofocus required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input type="number" class="form-control" value="<?php echo $row['amount']; ?>" name="amount" value="" required>
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('admin/reload_projectroom_expense/' . $project_code); ?>';
