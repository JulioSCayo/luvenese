    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/accounting_expense/edit/' . $param2), array(
                    'class' => 'form-horizontal form-groups-bordered expense-edit', 'enctype' => 'multipart/form-data')); ?>
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('admin/reload_expense_list'); ?>';
</script>
