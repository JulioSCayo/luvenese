                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control"
                                                   ...
                                                   value="<?php echo $paypal[0]->sandbox_client_id;?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control"
                                                   ...
                                                   value="<?php echo $paypal[0]->production_client_id;?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
                                            <?php echo get_phrase('influencer_id').' ('.get_phrase('sandbox').')'; ?>
                                        </label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control"
                                                   name="sandbox_influencer_id"
                                                   value="<?php echo $paypal[0]->sandbox_influencer_id;?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
                                            <?php echo get_phrase('influencer_id').' ('.get_phrase('production').')'; ?>
                                        </label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control"
                                                   name="production_influencer_id"
                                                   value="<?php echo $paypal[0]->production_influencer_id;?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
