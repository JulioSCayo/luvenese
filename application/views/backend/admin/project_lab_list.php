...
<table class="table  datatable" id="table-1">
    ...
    <tbody>
        ...
        $this->db->order_by('project_lab_id', 'desc');
        $project_files = $this->db->get_where('project_lab', array('project_id' => $project_id))->result_array();
            ...
            <tr class="odd gradeX">
                ...
                <td>
                    ...
                    <a class="tooltip-default" style="color:#aaa;" data-toggle="tooltip" 
                       ...
                       href="<?php echo site_url('admin/project_lab/download/' . $row1['project_lab_id']); ?>">
                    ...
                    <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip" 
                       ...
                       onclick="showAjaxModal('<?php echo site_url('modal/popup/project_lab_addto_dropbox/' . $row1['project_lab_id']); ?>')">

                        <i class="entypo-dropbox"></i>
                    </a>
                    <!-- DROPBOX SAVER BUTTON -->
                    <!--<div id="container_saver_<?php echo $row1['project_lab_id']; ?>"></div>-->

                    <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                       data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>"
                       onclick="confirm_modal('<?php echo site_url('admin/project_lab/delete/' . $row1['project_lab_id']); ?>', '<?php echo site_url('admin/reload_projectroom_lab_list/' . $project_code); ?>');">
                    ...
                    <script type="text/javascript">
                        ...
                        var options_saver_<?php echo $row1['project_lab_id']; ?> = {
                            files: [
                        ...
                        //var button_saver_<?php echo $row1['project_lab_id']; ?> = Dropbox.createSaveButton(options_saver_<?php echo $row1['project_lab_id']; ?>);
                        //document.getElementById("container_saver_<?php echo $row1['project_lab_id']; ?>").appendChild(button_saver_<?php echo $row1['project_lab_id']; ?>);
