<div class="panel panel-primary" id="charts_env">
    <div class="panel-heading">
        <div class="panel-title">
            ...
            <?php echo get_phrase('influencer_list');?>
        </div>
    </div>
    <div class="panel-body" >
        ...
        <tbody>
            <?php
            $counter = 1;
            $this->db->order_by('influencer_id', 'desc');
            ...
            foreach ($influencers as $row):
                ...
                <tr>
                    ...
                    <td>
                        <?php if(file_exists('uploads/influencer_image/'.$row['influencer_id'].'.jpg')): ?>
                            <img src="<?php echo base_url('uploads/influencer_image/'.$row['influencer_id'].'.jpg'); ?>" alt="" class="img-circle" width="50" height="50">
                        <?php else: ?>
                            <img src="<?php echo base_url('uploads/user.jpg'); ?>" alt="" class="img-circle" width="50" height="50">
                        <?php endif; ?>
                    </td>
                    <td><?php echo $row['address']; ?></td>
                    <td><?php echo $this->db->get_where('project', array('influencer_id' => $row['influencer_id']))->num_rows(); ?></td>
                    ...
                    <td>
                        ...
                        <!--<a class="btn btn-primary btn-xs tooltip-primary" data-toggle="tooltip" data-placement="top" 
                                  ...
                                  onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/influencer_profile/<?php echo $row['influencer_id']; ?>');">
                                          <i class="entypo-user"></i>
                            </a>
                         
                        <a class="btn btn-info btn-xs tooltip-primary" data-toggle="tooltip" data-placement="top" 
                                  title="" data-original-title="<?php echo get_phrase('edit_influencer'); ?>" 
                                  onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/influencer_edit/<?php echo $row['influencer_id']; ?>');">
                                          <i class="entypo-pencil"></i>
                            </a>
                         
                        <a class="btn btn-danger btn-xs tooltip-primary" data-toggle="tooltip" data-placement="top" 
                                  title="" data-original-title="<?php echo get_phrase('delete_influencer'); ?>" 
                                  onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/influencer/delete/<?php echo $row['influencer_id']; ?>' , '<?php echo base_url(); ?>index.php?admin/reload_influencer_list');" >
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                ...
                                <!-- PROFILE LINK -->
                                <li>
                                    <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/influencer_profile/' . $row['influencer_id']); ?>');">
                                        <i class="entypo-user"></i>
                                ...
                                <!-- EDITING LINK -->
                                <li>
                                    <a onclick="showAjaxModal('<?php echo site_url('modal/popup/influencer_edit/' . $row['influencer_id']); ?>');">
                                        <i class="entypo-pencil"></i>
                                ...
                                <!-- DELETION LINK -->
                                <li>
                                    <a href="#" onclick="confirm_modal('<?php echo site_url('admin/influencer/delete/' . $row['influencer_id']); ?>', '<?php echo site_url('admin/reload_influencer_list'); ?>');" >
                                        <i class="entypo-trash"></i>
