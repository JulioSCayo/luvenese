<?php $edit_data	=	$this->db->get_where('influencer' , array('influencer_id' => $param2))->result_array();
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/influencer/edit/'.$row['influencer_id']), array('class' => 'form-horizontal form-groups-bordered ajax-submit', 'enctype' => 'multipart/form-data'));?>
						...
						<div class="col-sm-7">
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
									<img src="<?php echo $this->crud_model->get_image_url('influencer' , $row['influencer_id']);?>" alt="...">
								</div>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-4 col-sm-7">
							<button type="submit" class="btn btn-info" id="submit-button"><?php echo get_phrase('edit_influencer');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
...
<script>
	...
	var post_refresh_url	=	'<?php echo site_url('admin/reload_influencer_list');?>';
