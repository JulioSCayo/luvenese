		...
		<div class="panel-heading">
            <div class="panel-title">
                ...
                <a href="#" class="pull-right tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit_task');?>"
                    onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_edit_archived/' . $row['team_task_id']); ?>');">
...
<div class="col-md-3">
    ...
    <div class="alert alert-warning">
        ...
        <a href="<?php echo site_url('admin/team_task/remove_from_archive/' . $row['team_task_id']);?>" 
	...
	<div class="panel panel-primary" data-collapsed="0">
        <div class="panel-heading">
            ...
            <?php if ($number_of_staffs > 0):?>
            	<a href="#" class="btn btn-default tooltip-primary btn-lg pull-right" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('add_staff');?>"
            		onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_edit_archived/' . $row['team_task_id']); ?>');" style="padding: 0px;">
        ...
        if ($number_of_staffs < 1):
    		...
    		<a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_edit_archived/' . $row['team_task_id']); ?>');">
            ...
            <div class="panel-title" style="width:100%;">
                ...
                <?php if ($team_task_files->num_rows() > 0):?>
                    <a href="#" class="btn btn-default btn-xs pull-right tooltip-primary" data-toggle="tooltip"  data-placement="left"
                            ...
                            onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_file_add_archived/' . $row['team_task_id']); ?>');">
        ...
        <div class="panel-body" style="padding:0px;">
            ...
            <table class="table table-striped">
                    ...
                    <?php if ($team_task_files->num_rows() < 1):?>
                    	<a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_file_add_archived/' . $row['team_task_id']); ?>');">
...
<script>
    ...
    function show_response_on_task_note_save(responseText, statusText, xhr, $form) {
        ...
        reload_team_task_information_archived('<?php echo site_url('admin/reload_team_task_information_archived/' . $team_task_id); ?>');
