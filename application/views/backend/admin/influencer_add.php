    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/influencer/create'), array('class' => 'form-horizontal form-groups-bordered', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <div class="checkbox checkbox-replace color-blue">
                            ...
                            <label> <?php echo get_phrase('notify_influencer'); ?></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-4 col-sm-7">
                        <button type="submit" class="btn btn-info" id="submit-button"><?php echo get_phrase('add_influencer'); ?></button>
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
