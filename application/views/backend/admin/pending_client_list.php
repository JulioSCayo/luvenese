                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <!-- APPROVAL LINK -->
                            <li>
                                <a href="<?php echo site_url('admin/pending_client/approve/' . $row['client_pending_id']);?>"
                            ...
                            <!-- DELETION LINK -->
                            <li>
                                <a href="#" onclick="confirm_modal('<?php echo site_url('admin/pending_client/delete/' . $row['client_pending_id']); ?>', '<?php echo site_url('admin/reload_pending_client_list'); ?>');" >
