	    ...
	    <div class="col-md-12">
	        <div class="panel panel-primary" data-collapsed="0">
	            ...
	            <div class="panel-body">
	                ...
	                <?php echo form_open(site_url('admin/calendar/edit/' . $param2), array(
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('admin/reload_event_calendar_body'); ?>';
    var delete_event_url = '<?php echo site_url('admin/calendar/delete/' . $param2);?>';
</script>
