...
<a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_add');?>');" 
    class="btn btn-info btn-block">
        ...
        ?>
        <a style="text-align: left;" href="<?php echo site_url('admin/team_task_view/' . $row['team_task_id']);?>" 
...
<div class="col-md-6">
    <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-heading">
            <div class="panel-title">
                ...
                <a href="#" class="pull-right tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete_this_task');?>"
                    onclick="confirm_modal_hard_reload('<?php echo site_url('admin/team_task/delete/' . $row['team_task_id']);?>');">
                ...
                <a href="#" class="pull-right tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit_task');?>"
                    onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_edit/' . $row['team_task_id']); ?>');">
        ...
        <div class="panel-body" style="padding:5px; background-color: #FFFCEE;">
            ...
            <?php echo form_open(site_url('admin/save_task_note/' . $row['team_task_id']), array('class' => 'task-note-save'));?>
...
<div class="col-md-3">
    ...
    <div class="alert alert-success">
        ...
        <a href="<?php echo site_url('admin/team_task/mark_archived/' . $row['team_task_id']);?>" 
    ...
    <div class="panel panel-primary" data-collapsed="0">
        <div class="panel-heading">
            <div class="panel-title"><i class="entypo-users"></i> <?php echo get_phrase('assigned_staff'); ?>
            
            <?php if ($number_of_staffs > 0):?>
                <a href="#" class="btn btn-default tooltip-primary btn-lg pull-right" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('add_staff');?>"
                    onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_edit/' . $row['team_task_id']); ?>');" style="padding: 0px;">
        ...
        if ($number_of_staffs < 1):
            ...
            <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_edit/' . $row['team_task_id']); ?>');">
            ...
            <div class="panel-title" style="width:100%;">
                ...
                <?php if ($team_task_files->num_rows() > 0):?>
                    <a href="#" class="btn btn-default btn-xs pull-right tooltip-primary" data-toggle="tooltip"  data-placement="left"
                            ...
                            onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_file_add/' . $row['team_task_id']); ?>');">
        ...
        <div class="panel-body" style="padding:0px;">
            ...
            <table class="table table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="padding: 8px 20px 0px 0px;">
                                <a href="<?php echo site_url('admin/team_task_file/download/' . $row3['team_task_file_id']); ?>">
                            ...
                            <td align="right">
                                <a href="#"
                                    onclick="confirm_modal('<?php echo site_url('admin/team_task_file/delete/' . $row3['team_task_file_id']); ?>', '<?php echo site_url('admin/reload_team_task_information_archived/' . $row['team_task_id']); ?>');">
                    ...
                    <?php if ($team_task_files->num_rows() < 1):?>
                        <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/team_task_file_add/' . $row['team_task_id']); ?>');">
...
<script>
    ...
    function show_response_on_task_note_save(responseText, statusText, xhr, $form) {
        ...
        reload_team_task_information('<?php echo site_url('admin/reload_team_task_information/' . $team_task_id); ?>');
