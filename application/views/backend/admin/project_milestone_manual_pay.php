...
<?php echo form_open(site_url('admin/project_milestone/take_manual_payment/' . $row['project_milestone_id']), array('class' => 'form-horizontal form-groups validate manual-payment'));?>
