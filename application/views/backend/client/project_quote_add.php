    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('client/project_quote/create'), array('class' => 'form-horizontal form-groups-bordered validate quote-add', 'enctype' => 'multipart/form-data')); ?>
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('client/reload_project_quote_list'); ?>';
</script>
