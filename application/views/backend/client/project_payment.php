                    ...
                    foreach ($milestones as $row2):
                        ...
                        <tr>
                            ...
                            <td align="right">
                                ...
                                <?php if ($row2['status'] != 1):?>
                                <a href="<?php echo site_url('client/project_milestone_pay/' . $row2['project_milestone_id'].'/'.$project_code);?>" class="btn btn-info" target="_blank">
                                ...
                                <a href="#" class="btn btn-white"
                                    onclick="showAjaxModal('<?php echo site_url('modal/popup/project_milestone_view/' . $row2['project_milestone_id']);?>')">
