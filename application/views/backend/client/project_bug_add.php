...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsedbug">
...
bugbug
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('client/project_bug/create/'.$param2), array('class' => 'form-horizontal form-groups-bordered validate project-bug-add', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <select name="status" class="form-control selectboxit">
                            ...
                            <option value="0" data-iconurl=""><?php echo gebughrase('pending'); ?></option>
...
bug
                          ...
                          bug       <span class="btn btn-primary btn-file">

                                        <span class="fileinput-new"><?php echo get_phrase('choose'); ?></span>

                                     bug<span class="fileinput-exists"><?php echo get_phrase('change'); ?></span>

                                        <input type="file" name="userfile" id="userfile">

                                    </span>

                               bug  <span class="fileinput-filename"></span>
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('client/reload_projectroom_bug/' . $param2); ?>';
