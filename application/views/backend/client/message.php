...
<div class="mail-env">
	...
	<div class="mail-sidebar-row visible-xs">
		<a href="<?php echo site_url('client/message/message_new');?>" class="btn btn-success btn-icon btn-block">
	...
	<div class="mail-sidebar" style="min-height: 800px;">
		...
		<ul class="mail-menu">
			...
			<li class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code'])echo 'active';?>">
				<a href="<?php echo site_url('client/message/message_read/' . $row['message_thread_code']);?>" style="padding:12px;">
