...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <?php echo form_open(site_url('payment/stripe_payment/pay/' . $project_milestone_id), array(
                'id' => 'payment-form' , 'class' => 'form-horizontal form-groups-bordered' , 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4">
                            ...
                            <a href="<?php echo site_url('client/projectroom/payment/' . $project_code);?>" class="btn btn-default">
