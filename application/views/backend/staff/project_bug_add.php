...
bugbug
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('staff/project_bug/create' . $param2), array('class' => 'form-horizontal form-groups-bordered validate project-bug-add', 'enctype' => 'multipart/form-data')); ?>
...
bug
                ...
                <div class="form-group">
                    ...
                    <label forbugield-1" class="col-sm-4 control-label"><?php echo get_phrase('select_file'); ?></label>



                    <div class="col-sm-6"bug

                        <div class="fileinput fileinput-new" data-provides="fileinput">

                            <span class="btn btn-primary btn-file">

                                <spbugclass="fileinput-new"><?php echo get_phrase('choose'); ?></span>
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('staff/reload_projectroom_bug/' . $param2); ?>';
