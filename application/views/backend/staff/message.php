...
<div class="mail-env">
	...
	<div class="mail-sidebar-row visible-xs">
		<a href="<?php echo site_url('staff/message/message_new');?>" class="btn btn-success btn-icon btn-block">
	...
	<div class="mail-sidebar" style="min-height: 800px;">
		...
		<ul class="mail-menu">
			...
			<li class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code'])echo 'active';?>">
				<a href="<?php echo site_url('staff/message/message_read/' . $row['message_thread_code']);?>" style="padding:12px;">
					<i class="entypo-dot"></i>
					
					<?php echo $this->db->get_where($user_to_show_type , array($user_to_show_type.'_id' => $user_to_show_id))->row()->name;?>

					<span class="badge badge-default pull-right" style=""><?php echo $user_to_show_type;?></span>
