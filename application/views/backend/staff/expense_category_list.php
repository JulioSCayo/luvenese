					...
					<td>
		            	<div class="btn-group">
		                    ...
		                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
		                        ...
		                        <!-- DELETION LINK -->
		                        <li>
		                            <a href="#" onclick="confirm_modal('<?php echo site_url('staff/accounting_expense_category/delete/' . $row['expense_category_id']);?>' , '<?php echo site_url('staff/reload_expense_category_list');?>');" >
