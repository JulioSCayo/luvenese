...
class Staff extends CI_Controller
{
    ...
    function team_task($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(site_url('staff/team_task_view/' . $team_task_id), 'refresh');
        }
        ...
        if ($param1 == 'mark_archived') {
            ...
            redirect(site_url('staff/team_task_archived'), 'refresh');
        }
        ...
        if ($param1 == 'remove_from_archive') {
            ...
            redirect(site_url('staff/team_task'), 'refresh');
        }
    ...
    {
        $this->load->view('backend/staff/expense_category_list');
    }
    /* support ticket */
    ...
    function project($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(site_url('staff/projectroom/wall/' . $project_code), 'refresh');
        }
        ...
        if ($param1 == 'edit') {
            ...
            redirect(site_url('index.php?staff/projectroom/edit/' . $param2), 'refresh');
        }
    ...
    function project_quote($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == "unarchive") {
            ...
            redirect(site_url('staff/project_quote'), 'refresh');
        }
    ...
    function pending_client($task = "", $client_pending_id = "")
    {
        ...
        if ($task == "approve") {
            ...
            redirect(site_url('staff/pending_client'), 'refresh');
        }
    ...
    function message($param1 = 'message_home', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'send_new') {
            ...
            redirect(site_url('staff/message/message_read/' . $message_thread_code), 'refresh');
        }
        
        if ($param1 == 'send_reply') {
            $this->crud_model->send_reply_message($param2); //$param2 = message_thread_code
            $this->session->set_flashdata('flash_message', get_phrase('message_sent!'));
            redirect(site_url('staff/message/message_read/' . $param2), 'refresh');
        }
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            redirect(site_url('staff/manage_profile'), 'refresh');
        }
        if ($param1 == 'change_password') {
            ...
            $current_password_db = $this->db->get_where('staff', array(
                'staff_id' => $this->session->userdata('login_user_id')
            ))->row()->password;
